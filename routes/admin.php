...
Route::group(['prefix' => 'users'], function () {
    ...
    Route::get('/view/{user}/resources', 'UserController@resources')->name('admin.users.store');

    Route::post('/new', 'UserController@store');
    Route::patch('/view/{user}', 'UserController@update');
    Route::patch('/view/{user}/resources', 'UserController@updateResources');
...
/*
|--------------------------------------------------------------------------
| Credits System Controller Routes
|--------------------------------------------------------------------------
|
