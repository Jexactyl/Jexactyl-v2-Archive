...
Route::prefix('/account')->middleware(AccountActivitySubject::class)->group(function () {
    ...
    Route::delete('/notifications', 'NotificationController@delete')->name('api:client.notification.delete')->withoutMiddleware(RequireTwoFactorAuthentication::class);
...
Route::group(['prefix' => '/store'], function () {
    Route::get('/config', 'Credits\ServerController@getConfig');
    Route::post('/create', 'Credits\ServerController@newServer');
